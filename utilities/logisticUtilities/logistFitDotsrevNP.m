function [fits_, fval] = logistFitDotsrevNP(data)

% NEW USING GLOBALSEARCH   
% Define the error function

errFcn = @(fits) logistErrDotsrev(logistValDotsrevNP(fits', data(:,1:end-1)), data(:,end));
...
problem = createOptimProblem('fmincon',    ...
   ...
   'x0',          [   0    0      0   g_sl   0.02], ...  % Initial conditions
   'lb',          [-300 -300  -0.05  0.001   0.01], ...  % Parameter lower bounds
   'ub',          [ 300  300   0.05   0.05   0.15], ...  % Parameter upper bounds
